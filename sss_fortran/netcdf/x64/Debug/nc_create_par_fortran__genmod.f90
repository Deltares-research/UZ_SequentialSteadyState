        ...
        MODULE NC_CREATE_PAR_FORTRAN__genmod
          INTERFACE 
            FUNCTION NC_CREATE_PAR_FORTRAN(STRING,MODE,COMM,INFO,NCID)  &
     & BIND(C, NAME = 'nc_create_par_fortran')
              ...
              INTEGER(KIND=4) :: NC_CREATE_PAR_FORTRAN
            END FUNCTION NC_CREATE_PAR_FORTRAN
          END INTERFACE 
        END MODULE NC_CREATE_PAR_FORTRAN__genmod
