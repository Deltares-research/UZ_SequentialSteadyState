        ...
        MODULE NF_GET_VARA__genmod
          INTERFACE 
            FUNCTION NF_GET_VARA(NCID,VARID,START,COUNTS,VALUES) RESULT(&
     &STATUS)
              INTEGER(KIND=4), INTENT(IN) :: NCID
              INTEGER(KIND=4), INTENT(IN) :: VARID
              INTEGER(KIND=4), INTENT(IN) :: START(*)
              INTEGER(KIND=4), INTENT(IN) :: COUNTS(*)
              CHARACTER(LEN=1) ,TARGET, INTENT(INOUT) :: VALUES(*)
              INTEGER(KIND=4) :: STATUS
            END FUNCTION NF_GET_VARA
          END INTERFACE 
        END MODULE NF_GET_VARA__genmod
